...
-- AlterTable
ALTER TABLE "patients" ADD COLUMN     "financial_plan" TEXT,
ADD COLUMN     "insurance_card_number" TEXT,
ADD COLUMN     "insurance_issued_at" TIMESTAMP(3),
ADD COLUMN     "insurance_name" TEXT,
ADD COLUMN     "insurance_payment_days" INTEGER,
ADD COLUMN     "insurance_repasse_type" TEXT,
ADD COLUMN     "insurance_repasse_value" DECIMAL(65,30);
