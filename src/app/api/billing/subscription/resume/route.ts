...
export async function POST(request: Request) {
  try {
    ...
    await updateStripeSubscriptionCancellation(stripeConfig, body.subscriptionId, false)

    return NextResponse.json(createApiResponse(null, "Renovação automática reativada"))
  } catch (error) {
