...
export function CalendarTimeline({ firstVisibleHour, lastVisibleHour }: IProps) {
  ...
  const formatCurrentTime = () => {
    return format(currentTime, "HH:mm", { locale: appDateLocale });
  };
  ...
  return (
    <div className="pointer-appointments-none absolute inset-x-0 z-50 border-t border-primary" style={{ top: `${getCurrentTimePosition()}%` }}>
