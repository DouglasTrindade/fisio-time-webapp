...
import { DraggableEvent } from "@/app/(protected)/agendamentos/_components/Calendar/components/dnd/draggable-event";
import { EventDetailsDialog } from "@/app/(protected)/agendamentos/_components/Calendar/components/dialogs/event-details-dialog";
